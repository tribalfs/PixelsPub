 ...
 * When successfully connected, enter the following to the command and press enter. You can copy the command below.  If the command executed properly, it'll return blank.
